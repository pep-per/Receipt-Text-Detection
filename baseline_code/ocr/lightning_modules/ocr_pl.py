...
class OCRPLModule(pl.LightningModule):
    def __init__(self, model, dataset, config):
        ...
        self.global_metric = CLEvalMetric()
        self.config = config
    ...
    def on_validation_epoch_end(self):
        ...
        self.log('val/global_recall', global_cleval['det_r'], on_epoch=True)
        self.log('val/global_precision', global_cleval['det_p'], on_epoch=True)
        self.log('val/global_hmean', global_cleval['det_h'], on_epoch=True)
    ...
    def on_test_epoch_end(self):
        ...
        self.log('test/global_recall', global_cleval['det_r'], on_epoch=True)
        self.log('test/global_precision', global_cleval['det_p'], on_epoch=True)
        self.log('test/global_hmean', global_cleval['det_h'], on_epoch=True)

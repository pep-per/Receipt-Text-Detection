...
| `V10-ALT` | SimSiam 또는 masked-image SSL 대체 | V10 뒤, V11 전 | MoCo v2가 기술적으로 부적합하거나 D0가 local-structure SSL 근거를 강하게 보일 때 하나만 대체 실험. 성능 실패 뒤 연속 algorithm sweep은 금지 |
